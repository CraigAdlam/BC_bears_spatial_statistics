...
ppp_bears_plot <- plot(ppp_bears,
                       ...
                       pch = 20, # c(15, 19, 18, 17, 20), # Set distinct point symbols for each region
...
# par(mfrow = c(1, 2)) # uncomment for final code
...
# # Barplot
# barplot(data_matrix, beside = TRUE, legend.text = levels, col = c("red", "blue", "green", "orange"),
#         main = "Trends Visualization", xlab = "Covariates", ylab = "Frequency",
...
$$
\lambda_{bears}(u) = e^{\text{-21.02311} - \text{0.002763701 Elev}(u) + \text{0.0000007955037 Elev}(u)^2 + \text{0.03139672 For}(u) - \text{0.0002180481 For}(u)^2 + \text{11.70025 HFI}(u) - \text{8.644236 HFI}(u)^2 - \text{0.00003768961 Wat}(u) - \text{0.000000005277563 Wat}(u)^2}
$$
...
dist_water_effect_on_elev <- effectfun(fit_bears, "Dist_Water", Elevation = median_elev, Forest = median_forest, HFI = median_HFI, se.fit = T)
