...
# par(mfrow = c(1,2)) # COMMENT OUT, ONLY FOR COMPARISON TO PARKS POINT PROCESS --- MIGHT NEED TO ADD ppp_parks ABOVE
...
# #Plot the output Note the use of image = TRUE # COMMENT OUT, ONLY FOR COMPARISON --- MIGHT NEED TO ADD ppp_parks ABOVE
...
# par(mfrow = c(1,2)) # COMMENT OUT, ONLY FOR COMPARISON --- MIGHT NEED TO ADD ppp_parks ABOVE

# Density estimation of lambda(u)
lambda_u_hat_bears <- density(ppp_bears)
...
# # Density estimation of lambda(u) # COMMENT OUT, ONLY FOR COMPARISON --- MIGHT NEED TO ADD ppp_parks ABOVE
# lambda_u_hat <- density(point_pattern)
# 
# # Plot the output Note the use of image = TRUE
# plot(lambda_u_hat,
...
# # PARKS BELOW HERE # COMMENT OUT, ONLY FOR COMPARISON --- MIGHT NEED TO ADD ppp_parks ABOVE
# plot(density(point_pattern, sigma = bw.ppl), # Likelihood Cross Validation Bandwidth Selection
#      ribbon = F,
